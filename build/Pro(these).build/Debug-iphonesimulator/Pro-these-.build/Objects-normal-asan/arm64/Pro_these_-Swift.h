...
#ifndef PRO_THESE__SWIFT_H
#define PRO_THESE__SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Pro_these_",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10Pro_these_11AppDelegate")
...
@interface BackgroundTaskItem (SWIFT_EXTENSION(Pro_these_))
...
@interface Contact (SWIFT_EXTENSION(Pro_these_))
...
@interface ContactPerson (SWIFT_EXTENSION(Pro_these_))
...
SWIFT_CLASS("_TtC10Pro_these_15EmailController")
...
@interface Event (SWIFT_EXTENSION(Pro_these_))
...
@interface EventTasks (SWIFT_EXTENSION(Pro_these_))
- (void)addEventsObject:(Event * _Nonnull)value;
- (void)removeEventsObject:(Event * _Nonnull)value;
- (void)addEvents:(NSSet * _Nonnull)values;
- (void)removeEvents:(NSSet * _Nonnull)values;
...
@interface Feeling (SWIFT_EXTENSION(Pro_these_))
@property (nonatomic, copy) NSDate * _Nullable date;
@property (nonatomic, copy) NSString * _Nullable name;
...
SWIFT_CLASS("_TtC10Pro_these_15GoogleAppOpenAd")
@interface GoogleAppOpenAd : NSObject <GADFullScreenContentDelegate>
...
SWIFT_CLASS("_TtC10Pro_these_20GoogleInterstitialAd")
@interface GoogleInterstitialAd : NSObject <GADFullScreenContentDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)ad:(id <GADFullScreenPresentingAd> _Nonnull)ad didFailToPresentFullScreenContentWithError:(NSError * _Nonnull)error;
- (void)adDidDismissFullScreenContent:(id <GADFullScreenPresentingAd> _Nonnull)ad;
@end
...
SWIFT_CLASS("_TtC10Pro_these_19HealthStoreProvider")
...
@interface Item (SWIFT_EXTENSION(Pro_these_))
...
@interface Liner (SWIFT_EXTENSION(Pro_these_))
...
SWIFT_CLASS("_TtC10Pro_these_16LocationProvider")
...
@interface Locations (SWIFT_EXTENSION(Pro_these_))
@property (nonatomic, copy) NSUUID * _Nullable id;
...
SWIFT_CLASS("_TtC10Pro_these_9NFCReader")
...
@interface Pain (SWIFT_EXTENSION(Pro_these_))
...
@interface PainDrug (SWIFT_EXTENSION(Pro_these_))
...
@interface PainReason (SWIFT_EXTENSION(Pro_these_))
...
@interface Prothese (SWIFT_EXTENSION(Pro_these_))
...
SWIFT_CLASS("_TtC10Pro_these_15PurchaseManager")
...
@interface PurchaseManager (SWIFT_EXTENSION(Pro_these_)) <SKPaymentTransactionObserver>
...
@interface RecurringEvents (SWIFT_EXTENSION(Pro_these_))
@property (nonatomic, copy) NSDate * _Nullable date;
...
@interface Report (SWIFT_EXTENSION(Pro_these_))
...
SWIFT_CLASS("_TtC10Pro_these_13SceneDelegate")
...
SWIFT_CLASS("_TtC10Pro_these_16SessionDelegater")
...
@interface SnapshotImage (SWIFT_EXTENSION(Pro_these_))
...
SWIFT_CLASS("_TtC10Pro_these_17StopWatchProvider")
@interface StopWatchProvider : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface WearingTimes (SWIFT_EXTENSION(Pro_these_))
