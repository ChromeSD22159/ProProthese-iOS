...
#ifndef PROTHESESINTENTSUI_SWIFT_H
#define PROTHESESINTENTSUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ProthesesIntentsUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18ProthesesIntentsUI20IntentViewController")
@interface IntentViewController : UIViewController <INUIHostedViewControlling>
- (void)viewDidLoad;
- (void)configureViewForParameters:(NSSet<INParameter *> * _Nonnull)parameters ofInteraction:(INInteraction * _Nonnull)interaction interactiveBehavior:(INUIInteractiveBehavior)interactiveBehavior context:(INUIHostedViewContext)context completion:(void (^ _Nonnull)(BOOL, NSSet<INParameter *> * _Nonnull, CGSize))completion;
...
SWIFT_CLASS("_TtC18ProthesesIntentsUI16SessionDelegater")
