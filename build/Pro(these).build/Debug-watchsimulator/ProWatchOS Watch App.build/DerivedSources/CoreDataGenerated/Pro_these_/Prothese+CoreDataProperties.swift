...
extension Prothese {
    ...
    @NSManaged public var wearingTimes: NSSet?
...
// MARK: Generated accessors for wearingTimes
extension Prothese {

    @objc(addWearingTimesObject:)
    @NSManaged public func addToWearingTimes(_ value: WearingTimes)

    @objc(removeWearingTimesObject:)
    @NSManaged public func removeFromWearingTimes(_ value: WearingTimes)

    @objc(addWearingTimes:)
    @NSManaged public func addToWearingTimes(_ values: NSSet)

    @objc(removeWearingTimes:)
    @NSManaged public func removeFromWearingTimes(_ values: NSSet)
