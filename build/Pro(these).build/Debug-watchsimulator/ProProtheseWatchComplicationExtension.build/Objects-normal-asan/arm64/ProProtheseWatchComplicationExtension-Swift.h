...
#ifndef PROPROTHESEWATCHCOMPLICATIONEXTENSION_SWIFT_H
#define PROPROTHESEWATCHCOMPLICATIONEXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ProProtheseWatchComplicationExtension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC37ProProtheseWatchComplicationExtension19HealthStoreProvider")
...
SWIFT_CLASS("_TtC37ProProtheseWatchComplicationExtension16SessionDelegater")
...
SWIFT_CLASS("_TtC37ProProtheseWatchComplicationExtension14WorkoutManager")
...
@interface WorkoutManager (SWIFT_EXTENSION(ProProtheseWatchComplicationExtension)) <HKWorkoutSessionDelegate>
...
@interface WorkoutManager (SWIFT_EXTENSION(ProProtheseWatchComplicationExtension)) <CLLocationManagerDelegate>
...
@interface WorkoutManager (SWIFT_EXTENSION(ProProtheseWatchComplicationExtension)) <HKLiveWorkoutBuilderDelegate>
