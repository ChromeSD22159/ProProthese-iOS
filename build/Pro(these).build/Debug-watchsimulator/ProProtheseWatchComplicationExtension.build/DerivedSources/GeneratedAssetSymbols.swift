...
extension ImageResource {
    ...
    static let prothesis = ImageResource(name: "prothesis", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "prothesis" asset catalog image.
    static var prothesis: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .prothesis)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "prothesis" asset catalog image.
    static var prothesis: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .prothesis)
#else
        .init()
