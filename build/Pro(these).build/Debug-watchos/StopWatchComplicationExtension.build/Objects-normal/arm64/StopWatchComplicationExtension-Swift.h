...
#ifndef STOPWATCHCOMPLICATIONEXTENSION_SWIFT_H
#define STOPWATCHCOMPLICATIONEXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="StopWatchComplicationExtension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC30StopWatchComplicationExtension17ExtensionDelegate")
...
SWIFT_CLASS("_TtC30StopWatchComplicationExtension19HealthStoreProvider")
...
SWIFT_CLASS("_TtC30StopWatchComplicationExtension16SessionDelegater")
...
SWIFT_CLASS("_TtC30StopWatchComplicationExtension14WorkoutManager")
...
@interface WorkoutManager (SWIFT_EXTENSION(StopWatchComplicationExtension)) <HKWorkoutSessionDelegate>
...
@interface WorkoutManager (SWIFT_EXTENSION(StopWatchComplicationExtension)) <CLLocationManagerDelegate>
...
@interface WorkoutManager (SWIFT_EXTENSION(StopWatchComplicationExtension)) <HKLiveWorkoutBuilderDelegate>
