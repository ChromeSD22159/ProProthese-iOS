...
#ifndef PROTHESESINTENTS_SWIFT_H
#define PROTHESESINTENTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ProthesesIntents",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface BackgroundTaskItem (SWIFT_EXTENSION(ProthesesIntents))
...
@interface Contact (SWIFT_EXTENSION(ProthesesIntents))
...
@interface ContactPerson (SWIFT_EXTENSION(ProthesesIntents))
...
@interface Event (SWIFT_EXTENSION(ProthesesIntents))
...
@interface EventTasks (SWIFT_EXTENSION(ProthesesIntents))
- (void)addEventsObject:(Event * _Nonnull)value;
- (void)removeEventsObject:(Event * _Nonnull)value;
- (void)addEvents:(NSSet * _Nonnull)values;
- (void)removeEvents:(NSSet * _Nonnull)values;
...
@interface Feeling (SWIFT_EXTENSION(ProthesesIntents))
@property (nonatomic, copy) NSDate * _Nullable date;
@property (nonatomic, copy) NSString * _Nullable name;
@property (nonatomic, strong) Prothese * _Nullable prothese;
@end

@class StopProthesenTimerIntent;
...
@class StartProthesenTimerIntent;
...
SWIFT_CLASS("_TtC16ProthesesIntents13IntentHandler")
@interface IntentHandler : INExtension <StartProthesenTimerIntentHandling, StopProthesenTimerIntentHandling>
- (void)handleStartProthesenTimer:(StartProthesenTimerIntent * _Nonnull)intent completion:(void (^ _Nonnull)(StartProthesenTimerIntentResponse * _Nonnull))completionHandler;
- (void)handleStopProthesenTimer:(StopProthesenTimerIntent * _Nonnull)intent completion:(void (^ _Nonnull)(StopProthesenTimerIntentResponse * _Nonnull))completionHandler;
...
@interface Item (SWIFT_EXTENSION(ProthesesIntents))
...
@interface Liner (SWIFT_EXTENSION(ProthesesIntents))
...
@interface Locations (SWIFT_EXTENSION(ProthesesIntents))
@property (nonatomic, copy) NSUUID * _Nullable id;
...
@interface Pain (SWIFT_EXTENSION(ProthesesIntents))
...
@interface PainDrug (SWIFT_EXTENSION(ProthesesIntents))
...
@interface PainReason (SWIFT_EXTENSION(ProthesesIntents))
...
@interface Prothese (SWIFT_EXTENSION(ProthesesIntents))
...
@interface RecurringEvents (SWIFT_EXTENSION(ProthesesIntents))
@property (nonatomic, copy) NSDate * _Nullable date;
...
@interface Report (SWIFT_EXTENSION(ProthesesIntents))
...
SWIFT_CLASS("_TtC16ProthesesIntents16SessionDelegater")
...
@interface SnapshotImage (SWIFT_EXTENSION(ProthesesIntents))
...
@interface WearingTimes (SWIFT_EXTENSION(ProthesesIntents))
